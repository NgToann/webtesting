<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FloatingScissorsReportDetailPage.aspx.cs" Inherits="WebsiteTesting.Pages.ScissorsManagment.FloatingScissorsReportDetailPage" MasterPageFile="~/Main.Master" %>
    ...
    <body>
        <div class="container SVContent">
            ...
            <section class="sectionHeader">
                <h1>AVAILABLE SCISSORS DETAIL</h1>
            </section>
            <div class="row">
                <div class="col-12">
